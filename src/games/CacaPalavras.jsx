    ...
    if (cells && cells.length > 1) {
      ...
      if (match && !foundWords.has(match.en)) {
        ...
        setFoundCells((prev) => {
          ...
          match.cells.forEach(([r, c]) => next.add(keyOf(r, c)));
          return next;
        });
      }
    }
  ...
  return (
    <div style={styles.wrap}>
      <div style={styles.topBar}>
        ...
        <span style={{ ...styles.hudItem, color: ACCENT }}>{foundWords.size}/{WORD_LIST.length}</span>
      </div>
      ...
      <div style={styles.card}>
        ...
        <div
          ref={gridRef}
          style={{ ...styles.grid, touchAction: "none" }}
            ...
            row.map((letter, c) => {
              ...
              return (
                <button
                  ...
                  style={{
                    ...styles.cell,
                    background: isFound ? ACCENT_BG : isPath ? "#FCEFD9" : "#FFFFFF",
                    borderColor: isFound ? ACCENT : isPath ? "#E8A33D" : "#D8D0BC",
                    color: isFound ? "#1F6058" : "#1B2735",
                  }}
                >
                  {letter}
                </button>
        ...
        <div style={styles.wordList}>
          {WORD_LIST.map((w) => (
            <span
              ...
              style={{
                ...styles.wordChip,
                textDecoration: foundWords.has(w.en) ? "line-through" : "none",
                opacity: foundWords.has(w.en) ? 0.5 : 1,
                borderColor: foundWords.has(w.en) ? ACCENT : "#D8D0BC",
              }}
            >
              {w.pt}
            </span>
...
const styles = {
  ...
  grid: { display: "grid", gridTemplateColumns: "repeat(10, 1fr)", gap: 2, background: "#D8D0BC", padding: 2, borderRadius: 3, userSelect: "none" },
